---
title: 'Agent Mesh：为什么多 Agent 协作需要一个"操作系统"'
date: 2026-05-17
draft: false
categories: ["项目介绍"]
tags: ["agent-mesh", "操作系统", "去中心化", "网络效应"]
series: ["Agent-Mesh 核心"]
summary: "Agent Mesh 的战略定位——它不是又一个编排框架，而是 Agent 世界的操作系统。从持久身份、去中心化通信、社交图谱到企业级价值，阐述 Mesh 的核心设计哲学。"
---
